...
describe('Skin Catalog', () => {
  it('should return skin catalog', async () => {
    const res = await fetch('http://localhost:3001/api/skins/catalog');
  ...
  it('should filter by type', async () => {
    const res = await fetch('http://localhost:3001/api/skins/catalog?type=CARD');
  ...
  it('should filter by category', async () => {
    const res = await fetch('http://localhost:3001/api/skins/catalog?category=Vietnamese%20Silk');
