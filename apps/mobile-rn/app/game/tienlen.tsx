...
export default function TienLenScreen() {
  ...
  const handleQuickPlay = () => {
    ...
    unityBridge.setGameMode('TIENLEN_QUICKPLAY');
  };

  const handleCreateRoom = () => {
    // Create a private room
    unityBridge.setGameMode('TIENLEN_ROOM');
  };
    ...
    return (
      <LinearGradient colors={[THEME.background, THEME.primary]} style={styles.container}>
        <View style={styles.loadingContent}>
          ...
          <Text style={styles.loadingText}>Loading Tiến Lên...</Text>
        </View>
      </LinearGradient>
    );
  }
    ...
    <LinearGradient colors={[THEME.background, THEME.primary]} style={styles.container}>
      ...
      <View style={styles.infoSection}>
        ...
        <Text style={styles.infoText}>
          • Vietnamese rules - 3♠ must be played first
        </Text>
        <Text style={styles.infoText}>
          • Winner of each round plays first next round
        </Text>
        <Text style={styles.infoText}>
          • 2-4 players, climb the ladder to win
        </Text>
      </View>
    </LinearGradient>
  );
